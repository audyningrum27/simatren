...
function Rapat() {
   ...
   return (
      <div>
         ...
         <div className="relative py-4 flex justify-between items-center w-full md:w-full px-4 md:px-0">
            ...
            <div className="flex justify-between mx-2 md:mx-10">
               <button onClick={() => navigate('/UserPage/histori_rapat')}
                  className="text-green-900 hover:underline font-semibold">Lihat semua rapat</button>
            </div>
         </div>
