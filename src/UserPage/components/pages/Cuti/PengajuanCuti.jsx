...
const PengajuanCuti = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('https://be-simatren.riset-d3rpla.com/api/data_cuti/cuti', formData, {
        headers: {
      ...
      if (response.status === 201) {
        // Ambil nama pegawai
        const { data: pegawai } = await axios.get(`https://be-simatren.riset-d3rpla.com/api/data_pegawai/pegawai/profil/${idPegawai}`);
        ...
        await axios.post('https://be-simatren.riset-d3rpla.com/api/data_notifikasi/notifikasi-admin/cuti', {
  ...
  const handleDownloadTemplate = async () => {
    try {
        const response = await axios.get('https://be-simatren.riset-d3rpla.com/api/data_cuti/download-template-cuti', {
            responseType: 'blob',
        });
