  ...
  const fetchNotifications = async () => {
    try {
      const response = await axios.all([
        axios.get(`https://backend.simatren.space/api/data_notifikasi/notifikasi-admin/cuti`),
        axios.get(`https://backend.simatren.space/api/data_notifikasi/notifikasi-admin/pelatihan`)
      ]);
  ...
  const handleNotificationClick = async (notification) => {
    try {
      const endpoint = notification.category === 'cuti'
        ? `https://backend.simatren.space/api/data_notifikasi/notifikasi-admin/cuti/${notification.id_notifikasi}`
        : `https://backend.simatren.space/api/data_notifikasi/notifikasi-admin/pelatihan/${notification.id_notifikasi}`;
