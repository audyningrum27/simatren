...
const DetailHistoryPelatihan = () => {
  ...
  const updateStatusPelatihan = async (id_pelatihan, status) => {
    try {
      ...
      await axios.put(`https://be-simatren.riset-d3rpla.com/api/data_pelatihan/pelatihan/status/${id_pelatihan}`,
        { status },
        {
          headers: {
      ...
      await axios.post('https://be-simatren.riset-d3rpla.com/api/data_notifikasi/notifikasi-pegawai/accpelatihan', {
  ...
  const viewBuktiPelaksanaan = () => {
    const url = `https://be-simatren.riset-d3rpla.com/api/data_pelatihan/pelatihan/view-bukti/${id_pelatihan}`;
    window.open(url, '_blank');
  };
