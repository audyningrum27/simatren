...
const TambahJadwalPelatihan = () => {
  ...
  useEffect(() => {
    axios.get('https://be-simatren.riset-d3rpla.com/api/data_pegawai/pegawai')
      .then(response => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.post('https://be-simatren.riset-d3rpla.com/api/data_pelatihan/pelatihan', dataPelatihan, {
        headers: {
      ...
      const notifikasiPromises = idPegawai.map(id => {
        ...
        return axios.post('https://be-simatren.riset-d3rpla.com/api/data_notifikasi/notifikasi-pegawai/pelatihan', {
          id_pegawai: id,
          message
        });
      });
