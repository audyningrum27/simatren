...
export default function DetailPegawai() {
    ...
    const fetchPegawaiDetail = async () => {
        try {
            const response = await fetch(`https://backend.simatren.space/api/data_pegawai/pegawai/${id_pegawai}`);
    ...
    const confirmDelete = async () => {
        try {
            await fetch(`https://backend.simatren.space/api/data_pegawai/pegawai/${id_pegawai}`, {
                method: 'DELETE',
            });
            setShowPopup(true);
            setIsDeleting(false);
