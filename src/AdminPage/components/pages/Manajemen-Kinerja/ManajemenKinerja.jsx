              ...
              <table className='text-gray-700 min-w-[900px]'>
                <thead className="sticky top-0 bg-white">
                  <tr className="border-b-[1.5px]">
                    ...
                    <td className='font-bold py-4'>Posisi</td>
                    <td className='font-bold py-4'>Status</td>
                    <td className='font-bold py-4'>Aksi</td>
                  </tr>
                </thead>
                <tbody>
                  ...
                  <tr key={index}>
                    ...
                    <td className='font-semibold'>
                      <button onClick={() => navigate(`/AdminPage/grafik_kinerja`)} className='flex justify-start items-center'>
                        Grafik Kinerja
