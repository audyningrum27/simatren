...
function Kinerja_Pelatihan() {
    ...
    useEffect(() => {
        axios.get(`https://be-simatren.riset-d3rpla.com/api/data_pelatihan/pelatihan-per-bulan/${id_pegawai}`)
            .then(response => {
            ...
            <div className="w-full mt-3 flex-1 text-sm">
                <ResponsiveContainer width="100%" height="100%">
                    ...
                    >
                        ...
                        <Tooltip />
                        <Legend />
                        <Bar dataKey="Selesai" fill='rgb(21 128 61)' /> {/* hijau */}
                        <Bar dataKey="Proses" fill='rgb(50, 140, 255)' /> {/* biru */}
                        <Bar dataKey="Belum Dimulai" fill='rgb(220, 0, 0)' /> {/* merah */}
                    </BarChart>
                </ResponsiveContainer>
            </div>
        </div>
