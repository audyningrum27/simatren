...
function ManajemenCuti() {
  ...
  const fetchDataCuti = async () => {
    try {
      const response = await fetch('https://be-simatren.riset-d3rpla.com/api/data_cuti/cuti/all');
  ...
  const handleYes = async () => {
    try {
      ...
      const response = await fetch(`https://be-simatren.riset-d3rpla.com/api/data_cuti/cuti/${selectedId}`, {
        method: 'PUT',
        headers: {
      ...
      if (response.ok) {
        ...
        const notificationResponse = await fetch('https://be-simatren.riset-d3rpla.com/api/data_notifikasi/notifikasi-pegawai/cuti', {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
          },
  ...
  const viewBuktiFormIzin = (id_cuti) => {
    const url = `https://be-simatren.riset-d3rpla.com/api/data_cuti/cuti/view-bukti/${id_cuti}`;
